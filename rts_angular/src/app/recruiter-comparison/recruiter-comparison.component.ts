...
@Component({
  ...
  templateUrl: './recruiter-comparison.component.html',
  styleUrls: ['./recruiter-comparison.component.css'],
  providers: [LoggedUserService]
})
export class RecruiterComparisonComponent implements OnInit {
  ...
  private recruiterComparison: any;
  ...
  ngOnInit() {
    ...
    this.getRecruiterComparison();
  }

  getRecruiterComparison() {
    const graph = {
