...
export class DiceIntergrationComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.contactMethod = [{ "name": "Email", "value": "hasEmail" }, { "name": "Phone", "value": "hasPhone" }];
    ...
    candidateFilter(form: FormGroup) {
        console.log(form)
        // const candidates = _.where(this.diceCandidates.data, { yearsOfExperience: parseInt(form.value.experience) });
