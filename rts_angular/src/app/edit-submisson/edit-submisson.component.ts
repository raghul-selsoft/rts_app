...
export class EditSubmissonComponent implements OnInit {
  ...
  getRequirement(event) {
    ...
    this.selectedPositionName = this.selectedRequirement.position.positionName;
    this.selectedLocation = this.selectedRequirement.location;
      ...
      .subscribe(
        data => {
          if (data.success) {
            ...
            this.selectedCandidateName = this.selectedSubmission.candidate.name;
            var skillText = [];
  ...
  getMailBodyMessage(event) {
    if (event.value === 'Yes') {
      ...
      this.customMailBody = '<span style="color: rgb(34, 34, 34); font-family: Arial, Helvetica, sans-serif; font-size: small;">Hi ' + this.clientRecruiterName + ',</span><br style="color: rgb(34, 34, 34); font-family: Arial, Helvetica, sans-serif; font-size: small;"><br style="color: rgb(34, 34, 34); font-family: Arial, Helvetica, sans-serif; font-size: small;"><span style="color: rgb(34, 34, 34); font-family: Arial, Helvetica, sans-serif; font-size: small;">Please find the attached resume of&nbsp;</span><b style="color: rgb(34, 34, 34); font-family: Arial, Helvetica, sans-serif; font-size: small;">' + this.selectedCandidateName + '</b><span style="color: rgb(34, 34, 34); font-family: Arial, Helvetica, sans-serif; font-size: small;">&nbsp;for the position of&nbsp;</span><b style="color: rgb(34, 34, 34); font-family: Arial, Helvetica, sans-serif; font-size: small;">' + this.selectedPositionName + '&nbsp;</b><span style="color: rgb(34, 34, 34); font-family: Arial, Helvetica, sans-serif; font-size: small;">at&nbsp;</span><b style="color: rgb(34, 34, 34); font-family: Arial, Helvetica, sans-serif; font-size: small;">' + this.selectedLocation + '</b><span style="color: rgb(34, 34, 34); font-family: Arial, Helvetica, sans-serif; font-size: small;">. Review his resume and let me know your thoughts.</span><br>';
    }
  }
      ...
      .subscribe(
        data => {
          if (data.success) {
            ...
            this.ngProgress.done();
            if (this.sendToClient) {
              this.submissionToClient(form.value.skillsExperience);
            } else {
              this.router.navigate(['submissions']);
            }
